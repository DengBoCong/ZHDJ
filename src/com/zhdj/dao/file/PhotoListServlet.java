...
@WebServlet(name = "PhotoListServlet", urlPatterns = "/photolist")
public class PhotoListServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String jsonMessage = "";
        if(flag.equals("1")){
            jsonMessage = photo.listKind(owner);
            System.out.println(photo.listKind(owner));
            if(jsonMessage.equals("[")){
                out.append("{\"flags\":\"0\"}");
            }else{
                out.append(photo.listKind(owner));
            }
        }else{
            out.append("{\"flags\":\"0\"}");
        }
